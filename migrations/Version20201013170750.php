 ...
 */
final class Version20201013170750 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__species AS SELECT id, user_id, created_at FROM species');
        $this->addSql('DROP TABLE species');
        $this->addSql('CREATE TABLE species (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, created_at DATETIME NOT NULL, genus VARCHAR(50) NOT NULL, species VARCHAR(50) NOT NULL, variety VARCHAR(60) DEFAULT NULL, CONSTRAINT FK_A50FF712A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO species (id, user_id, created_at) SELECT id, user_id, created_at FROM __temp__species');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__species AS SELECT id, user_id, created_at FROM species');
        $this->addSql('DROP TABLE species');
        $this->addSql('CREATE TABLE species (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, created_at DATETIME NOT NULL, common_name VARCHAR(60) NOT NULL COLLATE BINARY, scientific_name VARCHAR(60) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO species (id, user_id, created_at) SELECT id, user_id, created_at FROM __temp__species');
        $this->addSql('DROP TABLE __temp__species');
        $this->addSql('CREATE INDEX IDX_A50FF712A76ED395 ON species (user_id)');
        $this->addSql('DROP INDEX IDX_BD490429B2A1D860');
