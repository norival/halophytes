 ...
 */
final class Version20201013111203 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, user_id, title, url, created_at, abstract FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, url VARCHAR(255) NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL, abstract CLOB DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_23A0E66A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO article (id, user_id, title, url, created_at, abstract) SELECT id, user_id, title, url, created_at, abstract FROM __temp__article');
        ...
        $this->addSql('CREATE TABLE feature (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, data_type VARCHAR(60) NOT NULL COLLATE BINARY, unit VARCHAR(20) DEFAULT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__species AS SELECT id, user_id, created_at, common_name, scientific_name FROM species');
        $this->addSql('DROP TABLE species');
        $this->addSql('CREATE TABLE species (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, created_at DATETIME NOT NULL, common_name VARCHAR(60) NOT NULL COLLATE BINARY, scientific_name VARCHAR(60) NOT NULL COLLATE BINARY, CONSTRAINT FK_A50FF712A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO species (id, user_id, created_at, common_name, scientific_name) SELECT id, user_id, created_at, common_name, scientific_name FROM __temp__species');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_23A0E66A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__article AS SELECT id, user_id, title, url, abstract, created_at FROM article');
        $this->addSql('DROP TABLE article');
        $this->addSql('CREATE TABLE article (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, abstract CLOB DEFAULT NULL, created_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO article (id, user_id, title, url, abstract, created_at) SELECT id, user_id, title, url, abstract, created_at FROM __temp__article');
        $this->addSql('DROP TABLE __temp__article');
        $this->addSql('CREATE INDEX IDX_23A0E66A76ED395 ON article (user_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__feature AS SELECT id, name, data_type, unit, description FROM feature');
        $this->addSql('DROP TABLE feature');
        $this->addSql('CREATE TABLE feature (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, data_type VARCHAR(60) NOT NULL, description CLOB NOT NULL, unit VARCHAR(20) NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('DROP TABLE species');
        $this->addSql('CREATE TABLE species (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, common_name VARCHAR(60) NOT NULL, scientific_name VARCHAR(60) NOT NULL, created_at DATETIME NOT NULL)');
